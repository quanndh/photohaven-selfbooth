...
if %ERRORLEVEL% NEQ 0 (
    echo.
    echo NSSM (Non-Sucking Service Manager) is required to install as a Windows Service.
    echo.
    echo Please download NSSM from: https://nssm.cc/download
    echo Extract it and add the 64-bit or 32-bit folder to your PATH.
    echo.
    echo Alternatively, you can use Task Scheduler to run the application at startup:
...
nssm set %SERVICE_NAME% Description "Automatically applies Lightroom presets to images in watched folders"
